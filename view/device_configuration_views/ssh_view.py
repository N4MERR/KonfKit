"""
Provides the view for configuring SSH settings.
"""
from PySide6.QtWidgets import QLineEdit, QComboBox, QCheckBox, QHBoxLayout, QWidget, QPushButton
...
class SSHView(BaseConfigView):
    """
    View for configuring SSH device management.
    """
    ...
    def __init__(self):
        """
        Initializes the inputs for domain, crypto, VTY lines, and login credentials.
        """
        super().__init__()

        self.domain_input = QLineEdit()
        self.add_input_field("Domain Name:", self.domain_input, "domain")

        self.rsa_combo = QComboBox()
        self.rsa_combo.addItems(["512", "1024", "2048", "4096"])
        self.rsa_combo.setCurrentText("1024")
        self.add_input_field("RSA Key Size:", self.rsa_combo, "rsa")
        ...
        self.domain_input.installEventFilter(self)
    ...
    def _get_data(self):
        ...
        return {
            ...
            "rsa_size": self.rsa_combo.currentText(),
